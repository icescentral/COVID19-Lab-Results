...
*1. Set up ;
	...
	%let patientnotefile = covid19_2022_03_07_enc; /*use the newest cumulative OLIS file*/
...
*2. Pull data from two areas of OLIS: “observationvalue” under XON13543-4 and “patientnoteclinicalinformation”;
	...
	select coalesce(&patientid_resolved, &input_patientid) as &input_patientid, ordersid, 
	...
	libname fl XLSX '/data_olis_smb/olis/covid19/symptoms_list/FINAL_LIST_20220209_JK.xlsx';
